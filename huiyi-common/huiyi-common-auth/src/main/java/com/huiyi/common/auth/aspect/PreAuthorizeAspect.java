package com.huiyi.common.auth.aspect;
...
import com.huiyi.common.exception.ForbiddenException;
...
public class PreAuthorizeAspect
{
    ...
    @Around("@annotation(com.huiyi.common.auth.annotation.HasPermissions)")
