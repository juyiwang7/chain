package com.huiyi.common.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.huiyi.common.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.huiyi.common.redis.annotation.RedisEvict)")
