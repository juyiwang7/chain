...
import com.huiyi.common.redis.annotation.RedisEvict;
import com.huiyi.common.redis.util.RedisUtils;
...
public class AccessTokenService
{
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AccessTokenService.class);
...
//        log.debug("token:{}", token); // for swagger test
        System.out.println(token); // for swagger test
        // 保存或更新用户token
